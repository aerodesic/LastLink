...
#define SX127x_MODEM_STATUS_SIG_DETECTED   0x01  /* Signal has been detected */
#define SX127x_MODEM_STATUS_SIG_SYNCED     0x02  /* Signal synchronized */
#define SX127x_MODEM_STATUS_RX_ONGOING     0x04  /* Receive in progress */
#define SX127x_MODEM_STATUS_HEADER_VALID   0x08  /* Header is valid */
#define SX127x_MODEM_STATUS_CLEAR          0x10  /* Modem is idle */
#define SX127x_MODEM_STATUS_CODING_RATE    0xE0  /* Last coding rate recieved */
#define SX127x_MODEM_STATUS_CODING_RATE_45    0x10  /* 4/5 */
#define SX127x_MODEM_STATUS_CODING_RATE_46    0x20  /* 4/6 */
#define SX127x_MODEM_STATUS_CODING_RATE_47    0x20  /* 4/7 */
#define SX127x_MODEM_STATUS_CODING_RATE_48    0x20  /* 4/8 */
